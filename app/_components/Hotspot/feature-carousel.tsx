...
const FEATURES = [
  {
    ...
    description: "Walk with confidence wherever you put your steps.",
  },
   {
    id: "SB DUNCK",
    label: "Sb dunck",
    ...
    description: "Low pairs which enables you to walk with ease.",
  },
   {
    id: "NIKE SB ",
    label: " Nikes SB",
    ...
    description: "Red is royal, red is presence, red is real.",
  },
   {
    id: "NEW BALANCE",
    label: "new balance 350",
    icon: Shoe,
    image:
      "https://i.pinimg.com/1200x/c7/3e/76/c73e765bf76922b8642be6e419ffad72.jpg",
    description: "Before the hype, there was the hustle. The New Balance 350 is a tribute to the purists.",
  },
   {
    id: "TIMBERLAND",
    label: "timber land boots",
    icon: Shoe,
    image:
      "https://i.pinimg.com/736x/fb/50/7b/fb507ba64f02be14dc0cc4b1f5346860.jpg",
    description: "From construction sites to runway lights. The Timberland boot is the ultimate badge of authenticity.",
  },
   {
    id: "CONVERCE",
    label: "All stars",
    icon: Shoe,
    image:
      "https://i.pinimg.com/1200x/64/4a/7c/644a7c6c3b03d4514bacbff73a664559.jpg",
    description: "Rebels, artists, and dreamers—stand up. The Converse All Star doesn't need an introduction.",
  },
...
export function FeatureCarousel() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-8">
      ...
      <div className="flex justify-center items-center  py-6 px-6 mt-4 mb-4">
        <h1 className="text-sky-500 font-semibold text-4xl flex"> Spot Light</h1> <ArrowBigDown size={35} className="ml-4 animate-bounce  text-sky-500"/>
      </div>
